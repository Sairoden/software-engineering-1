...
const combineProduct = apparel
  ...
  .filter(item => {
    return (
      item.keywords.includes("Attack On Titan") +
      item.keywords.includes("Darling In The Franxx") +
      item.keywords.includes("Demon Slayer") +
      item.keywords.includes("Death Note") +
      item.keywords.includes("Jojos Bizarre") +
      item.keywords.includes("Tokyo Ghoul") +
      item.keywords.includes("Dragon Ball Z") +
      item.keywords.includes("Hunter X Hunter") +
      item.keywords.includes("My Hero Academia") +
      item.keywords.includes("My Neighbor Totoro") +
      item.keywords.includes("Naruto") +
      item.keywords.includes("One Piece") +
      ...
      <div className="product_page">
        ...
        <div className="filter">
          ...
          >
            ...
            <Option value="Jojos Bizarre Adventure">
